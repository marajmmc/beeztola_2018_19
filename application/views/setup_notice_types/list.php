        ...
        $("#system_jqx_container").jqxGrid(
            {
               ...
               /* rowsheight: 35,
                ...
                [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_REVISION_COUNT'); ?>',dataField: 'revision_count',width:'100',hidden: <?php echo $system_preference_items['revision_count']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_ORDERING'); ?>',dataField: 'ordering',width:'80',hidden: <?php echo $system_preference_items['ordering']?0:1;?>},
