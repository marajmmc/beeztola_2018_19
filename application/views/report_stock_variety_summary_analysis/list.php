    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'current_stock_pkt_cal', type: 'string' },
                { name: 'current_stock_kg', type: 'string' },
                { name: 'current_stock_kg_cal', type: 'string' }
            ],
            id: 'id',
            type: 'POST',
            url: url,
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_CURRENT_STOCK_PKT_CAL'); ?>', dataField: 'current_stock_pkt_cal',cellsrenderer: cellsrenderer,width:'100',cellsalign: 'right',hidden: <?php echo $system_preference_items['current_stock_pkt_cal']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_CURRENT_STOCK_KG_CAL'); ?>', dataField: 'current_stock_kg_cal',cellsrenderer: cellsrenderer,width:'100',cellsalign: 'right',hidden: <?php echo $system_preference_items['current_stock_kg_cal']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer}
                    ]
            });
    });
</script>
