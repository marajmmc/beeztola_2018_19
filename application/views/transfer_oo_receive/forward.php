...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_forward');?>" method="post">
    ...
    <div class="row widget">
                ...
                <table class="table table-bordered">
                    ...
                    foreach($items as $index=>$value)
                    {
                        ...
                        <tr id="item_rows_<?php echo $index+1;?>" class='<?php if($quantity_approve!=$quantity_receive){echo 'bg-danger';}?>'>
                            ...
                            <td class="text-right">
                                <label for=""><?php echo System_helper::get_string_quantity($quantity_receive); ?></label>
                            </td>
                            <td class="text-right">
                                <label > <?php echo System_helper::get_string_kg($quantity_receive_kg);?> </label>
                            </td>
                            <td class="text-right">
                                <label ><?php echo System_helper::get_string_quantity($stock_quantity_new); ?></label>
                            </td>
                            <td class="text-right">
                                <label ><?php echo System_helper::get_string_kg($stock_quantity_new_kg); ?> </label>
                            </td>
                        </tr>
                    <?php
                    }
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status_receive_forward" class="form-control" name="item[status_receive_forward]">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-4">
                <div class="action_button pull-right">
                    <button id="button_action_save" type="button" class="btn" data-form="#save_form" data-message-confirm="Are You Want to Showroom to Showroom Transfer Receive Approve Forward?">Save</button>
                </div>
            </div>
            <div class="col-sm-4 col-xs-4">
