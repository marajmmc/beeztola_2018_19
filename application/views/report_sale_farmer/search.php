    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-6">
                ...
                <div style="display: none" id="container_product">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change","#farmer_type_id",function()
        {
            ...
            if((outlet_id>0)&&farmer_type_id>0)
            {
                ...
                $.ajax({
                    url: '<?php echo site_url("common_controller/get_dropdown_farmers_by_outlet_farmer_type_id/");?>',
                    type: 'POST',
                    datatype: "JSON",
