...
if(isset($CI->permissions['action0']) && ($CI->permissions['action0']==1))
{
    ...
    (
        ...
        'data-action-link'=>site_url($CI->controller_url.'/index/details_all_payment')
    );
}
if(isset($CI->permissions['action4']) && ($CI->permissions['action4']==1))
{
    $action_buttons[]=array(
        ...
        'class'=>'button_jqx_action',
        'data-action-link'=>site_url($CI->controller_url.'/index/details_print_all_payment')
    );
    $action_buttons[]=array(
        'type'=>'button',
...
if(isset($CI->permissions['action6']) && ($CI->permissions['action6']==1))
{
    ...
    (
        'label'=>'Preference',
        'href'=>site_url($CI->controller_url.'/index/set_preference_all_payment')
    );
}
$action_buttons[]=array(
