    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'amount_budget', type: 'string' }
            ],
            id: 'id',
            url: url,
            type: 'POST',
        ...
        $("#system_jqx_container").jqxGrid(
        {
            ...
            columns: [
                ...
                {
                    text: 'Budget', dataField: 'amount_budget', width:'200',cellsalign: 'right', cellsrenderer: cellsrenderer, columntype:'custom',
                    editable:true,
