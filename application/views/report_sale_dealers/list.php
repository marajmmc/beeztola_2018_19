        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columngroups:
                    [
                            <?php
                                foreach($dealers as $dealer)
                                {?>{ text: '<?php echo $dealer['farmer_name']; ?>', align: 'center', name: '<?php echo $dealer['farmer_id']; ?>' },
                        <?php
                            }
                        ?>
