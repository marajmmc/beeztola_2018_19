        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columnsreorder: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('LABEL_ID'); ?>', dataField: 'id',pinned:true,width:'40',cellsAlign:'right',hidden: <?php echo $system_preference_items['id']?0:1;?>},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DATE_SALE'); ?>', dataField: 'date_sale',width:'200',cellsrenderer: cellsrenderer, hidden: <?php echo $system_preference_items['date_sale']?0:1;?>},
