...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var cellsrenderer = function(row, column, value, defaultHtml, columnSettings, record)
        {
            ...
            if((column=='amount_payment')||(column=='amount_cash_sale_payment')||(column=='amount_credit_sale_payment'))
            {
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_AMOUNT_CASH_SALE_PAYMENT'); ?>',dataField: 'amount_cash_sale_payment',width:'150',cellsAlign:'right',cellsrenderer: cellsrenderer, hidden: <?php echo $system_preference_items['amount_cash_sale_payment']?0:1;?>},
