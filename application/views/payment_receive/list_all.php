        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_STATUS_FORWARD'); ?>',dataField: 'status_forward',width:'130',filterType:'list',hidden: <?php echo $system_preference_items['status_forward']?0:1;?>},
                        { text: '<?php echo $CI->lang->line('LABEL_STATUS_RECEIVE'); ?>',dataField: 'status_receive',width:'130',filterType:'list',hidden: <?php echo $system_preference_items['status_receive']?0:1;?>}
                    ]
            });
    });
</script>
