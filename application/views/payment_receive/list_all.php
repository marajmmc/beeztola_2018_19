...
if(isset($CI->permissions['action0']) && ($CI->permissions['action0']==1))
{
    ...
    (
        ...
        'data-action-link'=>site_url($CI->controller_url.'/index/details_all_receive')
    );
}
...
if(isset($CI->permissions['action6']) && ($CI->permissions['action6']==1))
{
    ...
    (
        'label'=>'Preference',
        'href'=>site_url($CI->controller_url.'/index/set_preference_all_receive')
    );
}
$action_buttons[]=array(
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_STATUS_RECEIVE'); ?>',dataField: 'status_receive',width:'150',filterType:'list',hidden: <?php echo $system_preference_items['status_receive']?0:1;?>}
                    ]
            });
    });
</script>
