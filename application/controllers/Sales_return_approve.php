...
class Sales_return_approve extends Root_Controller
{
    ...
    private function system_edit($id)
    {
        if(isset($this->permissions['action2'])&&($this->permissions['action2']==1))
        {
            ...
            if($data['item']['date_return_approved']>0)
            {
                $user_ids[$data['item']['date_return_approved']]=$data['item']['date_return_approved'];
            }
            ...
            $date_start=System_helper::get_time(System_helper::display_date($data['item']['date_return_requested']))-3600*24*$result['config_value'];
